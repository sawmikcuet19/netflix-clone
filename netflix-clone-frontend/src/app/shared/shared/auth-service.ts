...
export class AuthService {
  ...
  passwordMatchValidator(passwordControlName: string): Validators {
  ...
  changePassword(changePassworsData: any) {
    return this.http.post(this.apiUrl + '/change-password', changePassworsData);
  }
